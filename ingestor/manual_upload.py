...
# When running inside container, all files are in same dir — no path adjustment needed
# When running locally, add ingestor/ to path
_ingestor_dir = Path(__file__).parent / "ingestor"
if _ingestor_dir.exists():
